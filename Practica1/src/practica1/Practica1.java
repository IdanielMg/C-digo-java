    ...
    public static void main(String[] args) 
    {
        ...
        do
        {
            ...
            switch(opc)
            {
                ...
                case '6':
                    objLista.intercambio();
                    System.out.println("Intercambio entre el segundo y el ultimo realizado...");
                    break;
                    
                case '7':
//                    objLista.EliminarPares();
//                    System.out.println("");
      ...
      static char Menu()
    {
        ...
        System.out.println("\t\t6. intercambio");
        System.out.println("\t\t7. Eliminar pares");
